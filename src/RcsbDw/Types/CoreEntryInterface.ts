...
export interface CoreEntry {
  ...
  pdbx_vrpt_summary?: {
     ...
     */
    EMDB_deposition_date?: string;
    /**
     * Either a decimal number or the string "NotAvailable".
     */
    EMDB_resolution?: number;
    /**
     ...
     * Either a decimal number or the string "NotAvailable".
     */
    PDB_resolution?: number;
    /**
     * Either a decimal number or the string "NotAvailable".
     */
    PDB_resolution_low?: number;
    /**
     ...
     */
    absolute_percentile_DCC_Rfree?: number;
    /**
     * Structures are judged in comparison to previously deposited PDB entries.
     * The comparison is carried out by calculation of the percentile rank, i.e. the percentage of entries
     * that are equal or poorer than this structure in terms of a quality indicator.
     * Percentile ranks range from 0 (the worst) to 100 (the best).
     */
    absolute_percentile_RNA_suiteness?: number;
    /**
     * Structures are judged in comparison to previously deposited PDB entries.
     * The comparison is carried out by calculation of the percentile rank, i.e. the percentage of entries
     * that are equal or poorer than this structure in terms of a quality indicator.
     * Percentile ranks range from 0 (the worst) to 100 (the best).
     */
    absolute_percentile_clashscore?: number;
    /**
     * Structures are judged in comparison to previously deposited PDB entries.
     * The comparison is carried out by calculation of the percentile rank, i.e. the percentage of entries
     * that are equal or poorer than this structure in terms of a quality indicator.
     * Percentile ranks range from 0 (the worst) to 100 (the best).
     */
    absolute_percentile_percent_RSRZ_outliers?: number;
    /**
     * Structures are judged in comparison to previously deposited PDB entries.
     * The comparison is carried out by calculation of the percentile rank, i.e. the percentage of entries
     * that are equal or poorer than this structure in terms of a quality indicator.
     * Percentile ranks range from 0 (the worst) to 100 (the best).
     */
    absolute_percentile_percent_ramachandran_outliers?: number;
    /**
     * Structures are judged in comparison to previously deposited PDB entries.
     * The comparison is carried out by calculation of the percentile rank, i.e. the percentage of entries
     * that are equal or poorer than this structure in terms of a quality indicator.
     * Percentile ranks range from 0 (the worst) to 100 (the best).
     */
    absolute_percentile_percent_rotamer_outliers?: number;
    /**
     ...
     */
    chemical_shifts_input_filename?: string;
    /**
     ...
     */
    high_resol_relative_percentile_DCC_Rfree?: number;
    /**
     * The resolution bin limit in Angstroms for PDB depositions used in the comparison when calculating
     ...
     */
    high_resol_relative_percentile_RNA_suiteness?: number;
    /**
     * The resolution bin limit in Angstroms for PDB depositions used in the comparison when calculating
     ...
     * Produced by the percentiles step of the validation pipeline software.
     */
    high_resol_relative_percentile_clashscore?: number;
    /**
     * The resolution bin limit in Angstroms for PDB depositions used in the comparison when calculating
     ...
     * Example:            X-ray entry specific, produced by the percentiles step of the validation pipeline software.
     */
    high_resol_relative_percentile_percent_RSRZ_outliers?: number;
    /**
     * The resolution bin limit in Angstroms for PDB depositions used in the comparison when calculating
     ...
     * Produced by the percentiles step of the validation pipeline software.
     */
    high_resol_relative_percentile_percent_ramachandran_outliers?: number;
    /**
     * The resolution bin limit in Angstroms for PDB depositions used in the comparison when calculating
     ...
     * Produced by the percentiles step of the validation pipeline software.
     */
    high_resol_relative_percentile_percent_rotamer_outliers?: number;
    /**
     * The string "yes".
     */
     ...
     * Example:            X-ray entry specific, produced by the percentiles step of the validation pipeline software.
     */
    low_resol_relative_percentile_DCC_Rfree?: number;
    /**
     * The resolution bin limit in Angstroms for PDB depositions used in the comparison when calculating
     * the attribute "relative-percentile-RNAsuiteness".
     ...
     * Produced by the percentiles step of the validation pipeline software.
     */
    low_resol_relative_percentile_RNA_suiteness?: number;
    /**
     * The resolution bin limit in Angstroms for PDB depositions used in the comparison when calculating
     * the attribute "relative-percentile-clashscore".
     ...
     * Produced by the percentiles step of the validation pipeline software.
     */
    low_resol_relative_percentile_clashscore?: number;
    /**
     * The resolution bin limit in Angstroms for PDB depositions used in the comparison when calculating
     * the attribute "relative-percentile-percent-RSRZ-outliers".
     ...
     * Example:            X-ray entry specific, produced by the percentiles step of the validation pipeline software.
     */
    low_resol_relative_percentile_percent_RSRZ_outliers?: number;
    /**
     * The resolution bin limit in Angstroms for PDB depositions used in the comparison when calculating
     * the attribute "relative-percentile-percent-rama-outliers".
     ...
     * Produced by the percentiles step of the validation pipeline software.
     */
    low_resol_relative_percentile_percent_ramachandran_outliers?: number;
    /**
     * The resolution bin limit in Angstroms for PDB depositions used in the comparison when calculating
     * the attribute "relative-percentile-percent-rota-outliers".
     ...
     * Produced by the percentiles step of the validation pipeline software.
     */
    low_resol_relative_percentile_percent_rotamer_outliers?: number;
    /**
     ...
     * Example:            X-ray entry specific, produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_absolute_percentile_DCC_Rfree?: number;
    /**
     * The number of PDB depositions used in the comparison when calculating the attribute
     ...
     * Produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_absolute_percentile_RNA_suiteness?: number;
    /**
     * The number of PDB depositions used in the comparison when calculating the attribute
     * "absolute-percentile-clashscore"
     * Example:             Produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_absolute_percentile_clashscore?: number;
    /**
     * The number of PDB depositions used in the comparison when calculating the attribute
     * "absolute-percentile-percent-RSRZ-outliers".
     * Example:            X-ray entry specific, produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_absolute_percentile_percent_RSRZ_outliers?: number;
    /**
     * The number of PDB depositions used in the comparison when calculating the attribute
     * "absolute-percentile-percent-rama-outliers"
     * Example:            Produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_absolute_percentile_percent_ramachandran_outliers?: number;
    /**
     * The number of PDB depositions used in the comparison when calculating the attribute
     * "absolute-percentile-percent-rota-outliers"
     * Example:             Produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_absolute_percentile_percent_rotamer_outliers?: number;
    /**
     * The number of PDB depositions used in the comparison when calculating the attribute
     * "relative-percentile-DCC_Rfree".
     * Example:            X-ray entry specific, produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_relative_percentile_DCC_Rfree?: number;
    /**
     * The number of PDB depositions used in the comparison when calculating the attribute
     ...
     * Produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_relative_percentile_RNA_suiteness?: number;
    /**
     * The number of PDB depositions used in the comparison when calculating the attribute
     * "relative-percentile-clashscore"
     * Example:            Produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_relative_percentile_clashscore?: number;
    /**
     * The number of PDB depositions used in the comparison when calculating the attribute
     * "relative-percentile-percent-RSRZ-outliers".
     * Example:            X-ray entry specific, produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_relative_percentile_percent_RSRZ_outliers?: number;
    /**
     * The number of PDB depositions used in the comparison when calculating the attribute
     * "relative-percentile-percent-rama-outliers"
     * Example:            Produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_relative_percentile_percent_ramachandran_outliers?: number;
    /**
     * The number of PDB depositions used in the comparison when calculating the attribute
     * "relative-percentile-percent-rota-outliers"
     * Example:            Produced by the percentiles step of the validation pipeline software.
     */
    num_PDBids_relative_percentile_percent_rotamer_outliers?: number;
    /**
     ...
     * Example
     */
    protein_DNA_RNA_entities?: string;
    /**
     ...
     * Percentile ranks range from 0 (the worst) to 100 (the best).
     */
    relative_percentile_DCC_Rfree?: number;
    /**
     * Structures are judged in comparison to previously deposited PDB entries.
     * The comparison is carried out by calculation of the percentile rank, i.e. the percentage of entries
     * that are equal or poorer than this structure in terms of a quality indicator.
     * Percentile ranks range from 0 (the worst) to 100 (the best).
     */
    relative_percentile_RNA_suiteness?: number;
    /**
     * Structures are judged in comparison to previously deposited PDB entries.
     * The comparison is carried out by calculation of the percentile rank, i.e. the percentage of entries
     * that are equal or poorer than this structure in terms of a quality indicator.
     * Percentile ranks range from 0 (the worst) to 100 (the best).
     */
    relative_percentile_clashscore?: number;
    /**
     * Structures are judged in comparison to previously deposited PDB entries.
     * The comparison is carried out by calculation of the percentile rank, i.e. the percentage of entries
     * that are equal or poorer than this structure in terms of a quality indicator.
     * Percentile ranks range from 0 (the worst) to 100 (the best).
     */
    relative_percentile_percent_RSRZ_outliers?: number;
    /**
     * Structures are judged in comparison to previously deposited PDB entries.
     * The comparison is carried out by calculation of the percentile rank, i.e. the percentage of entries
     * that are equal or poorer than this structure in terms of a quality indicator.
     * Percentile ranks range from 0 (the worst) to 100 (the best).
     */
    relative_percentile_percent_ramachandran_outliers?: number;
    /**
     * Structures are judged in comparison to previously deposited PDB entries.
     * The comparison is carried out by calculation of the percentile rank, i.e. the percentage of entries
     * that are equal or poorer than this structure in terms of a quality indicator.
     * Percentile ranks range from 0 (the worst) to 100 (the best).
     */
    relative_percentile_percent_rotamer_outliers?: number;
    /**
  ...
  rcsb_external_references?: {
     ...
     */
    type: "OLDERADO" | "BMRB" | "NDB" | "SB GRID" | "PROTEIN DIFFRACTION" | "EM DATA RESOURCE";
    /**
