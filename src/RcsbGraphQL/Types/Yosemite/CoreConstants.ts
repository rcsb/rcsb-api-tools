export class CoreConstants{
	...
	public static readonly RCSB_ASSEMBLY_ANNOTATION = "rcsb_assembly_annotation";
	public static readonly RCSB_ASSEMBLY_CONTAINER_IDENTIFIERS = "rcsb_assembly_container_identifiers";
	public static readonly RCSB_ASSEMBLY_FEATURE = "rcsb_assembly_feature";
	...
	public static readonly IHM_ENTRY_COLLECTION_MAPPING = "ihm_entry_collection_mapping";
	public static readonly IHM_EXTERNAL_REFERENCE_INFO = "ihm_external_reference_info";
	...
	public static readonly PDBX_VRPT_SUMMARY_DIFFRACTION = "pdbx_vrpt_summary_diffraction";
	public static readonly PDBX_VRPT_SUMMARY_EM = "pdbx_vrpt_summary_em";
	public static readonly PDBX_VRPT_SUMMARY_GEOMETRY = "pdbx_vrpt_summary_geometry";
	public static readonly PDBX_VRPT_SUMMARY_NMR = "pdbx_vrpt_summary_nmr";
	...
	public static readonly RCSB_IHM_DATASET_LIST = "rcsb_ihm_dataset_list";
	public static readonly RCSB_IHM_DATASET_SOURCE_DB_REFERENCE = "rcsb_ihm_dataset_source_db_reference";
	...
	public static readonly PDBX_VRPT_SUMMARY_ENTITY_FIT_TO_MAP = "pdbx_vrpt_summary_entity_fit_to_map";
	public static readonly PDBX_VRPT_SUMMARY_ENTITY_GEOMETRY = "pdbx_vrpt_summary_entity_geometry";
	...
	public static readonly PDBX_DOI = "pdbx_DOI";
	public static readonly PDBX_DATABASE_ACCESSION = "pdbx_database_accession";
	...
	public static readonly DRUG_PRODUCTS = "drug_products";
	...
	public static readonly ENDED_MARKETING_ON = "ended_marketing_on";
	public static readonly STARTED_MARKETING_ON = "started_marketing_on";
	...
	public static readonly COLLECTION_ID = "collection_id";
	public static readonly ASSOCIATED_URL = "associated_url";
	public static readonly REFERENCE = "reference";
	public static readonly REFERENCE_PROVIDER = "reference_provider";
	...
	public static readonly CCP4_VERSION = "CCP4_version";
	public static readonly DCC_R = "DCC_R";
	public static readonly DCC_RFREE = "DCC_Rfree";
	public static readonly EDS_R = "EDS_R";
	public static readonly EDS_R_WARNING = "EDS_R_warning";
	public static readonly EDS_RES_HIGH = "EDS_res_high";
	public static readonly EDS_RES_LOW = "EDS_res_low";
	public static readonly FO_FC_CORRELATION = "Fo_Fc_correlation";
	public static readonly I_OVER_SIGMA = "I_over_sigma";
	public static readonly PADILLA_YEATES_L2_MEAN = "Padilla_Yeates_L2_mean";
	public static readonly PADILLA_YEATES_L_MEAN = "Padilla_Yeates_L_mean";
	public static readonly Q_SCORE = "Q_score";
	...
	public static readonly DENSITY_FITNESS_VERSION = "density_fitness_version";
	public static readonly EXP_METHOD = "exp_method";
	public static readonly NUM_MILLER_INDICES = "num_miller_indices";
	public static readonly NUMBER_REFLNS_R_FREE = "number_reflns_R_free";
	...
	public static readonly SERVALCAT_VERSION = "servalcat_version";
	public static readonly TRANS_NCS_DETAILS = "trans_NCS_details";
	...
	public static readonly AVERAGE_RESIDUE_INCLUSION = "average_residue_inclusion";
	...
	public static readonly STRUCT_OPER_LIST = "struct_oper_list";
	...
	public static readonly IHM_STRUCTURE_DESCRIPTION = "ihm_structure_description";
	...
	public static readonly REPRESENTATIVE_MODEL = "representative_model";
	...
	public static readonly NATOMS_EDS = "natoms_eds";
	public static readonly NUM_MOGUL_ANGLES_RMSZ = "num_mogul_angles_RMSZ";
	public static readonly NUM_MOGUL_BONDS_RMSZ = "num_mogul_bonds_RMSZ";
	...
	public static readonly ENTITY_SEQUENCE_COVERAGE = "entity_sequence_coverage";
	public static readonly REFERENCE_SEQUENCE_COVERAGE = "reference_sequence_coverage";
