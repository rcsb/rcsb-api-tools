...
export var RcsbCandidateAssembly;
(function (RcsbCandidateAssembly) {
    RcsbCandidateAssembly["N"] = "N";
    RcsbCandidateAssembly["Y"] = "Y";
})(RcsbCandidateAssembly || (RcsbCandidateAssembly = {}));
export var RcsbDetails;
...
})(RcsbDetails || (RcsbDetails = {}));
export var NaPolymerEntityTypes;
...
})(NaPolymerEntityTypes || (NaPolymerEntityTypes = {}));
export var PolymerComposition;
(function (PolymerComposition) {
    PolymerComposition["Dna"] = "DNA";
})(PolymerComposition || (PolymerComposition = {}));
export var SelectedPolymerEntityTypes;
...
})(SelectedPolymerEntityTypes || (SelectedPolymerEntityTypes = {}));
export var Kind;
(function (Kind) {
...
export var LigandIsBound;
(function (LigandIsBound) {
    LigandIsBound["N"] = "N";
    LigandIsBound["Y"] = "Y";
})(LigandIsBound || (LigandIsBound = {}));
export var PdbxType;
(function (PdbxType) {
...
})(PdbxProcessingSite || (PdbxProcessingSite = {}));
export var PdbxReleaseStatus;
...
})(PdbxReleaseStatus || (PdbxReleaseStatus = {}));
export var ProcessingSite;
...
export var ReferenceDatabaseName;
...
export var PdbxSerialCrystalExperiment;
(function (PdbxSerialCrystalExperiment) {
    PdbxSerialCrystalExperiment["N"] = "N";
    PdbxSerialCrystalExperiment["Y"] = "Y";
})(PdbxSerialCrystalExperiment || (PdbxSerialCrystalExperiment = {}));
export var PdbxMonochromaticOrLaueML;
(function (PdbxMonochromaticOrLaueML) {
    PdbxMonochromaticOrLaueML["L"] = "L";
    PdbxMonochromaticOrLaueML["M"] = "M";
})(PdbxMonochromaticOrLaueML || (PdbxMonochromaticOrLaueML = {}));
export var PdbxScatteringType;
...
})(PdbxScatteringType || (PdbxScatteringType = {}));
export var RefProtocol;
...
})(RefProtocol || (RefProtocol = {}));
export var RefSpace;
(function (RefSpace) {
    RefSpace["Real"] = "REAL";
    RefSpace["Reciprocal"] = "RECIPROCAL";
})(RefSpace || (RefSpace = {}));
export var SymmetryType;
...
export var ReconstructionMethod;
...
})(AlignmentProcedure || (AlignmentProcedure = {}));
export var Cryogen;
(function (Cryogen) {
    Cryogen["Helium"] = "HELIUM";
    Cryogen["Nitrogen"] = "NITROGEN";
})(Cryogen || (Cryogen = {}));
export var IlluminationMode;
...
})(InitialOfCenter || (InitialOfCenter = {}));
export var Provider;
(function (Provider) {
...
})(DepositSite || (DepositSite = {}));
export var MethodsDevelopmentCategory;
...
})(MethodsDevelopmentCategory || (MethodsDevelopmentCategory = {}));
export var PdbFormatCompatible;
(function (PdbFormatCompatible) {
    PdbFormatCompatible["N"] = "N";
    PdbFormatCompatible["Y"] = "Y";
})(PdbFormatCompatible || (PdbFormatCompatible = {}));
export var ProcessSite;
...
})(StatusCodeCs || (StatusCodeCs = {}));
export var StatusCodeMr;
...
})(StatusCodeMr || (StatusCodeMr = {}));
export var StatusCodeSf;
...
export var IhmEnsembleFlag;
(function (IhmEnsembleFlag) {
    IhmEnsembleFlag["N"] = "N";
    IhmEnsembleFlag["Y"] = "Y";
})(IhmEnsembleFlag || (IhmEnsembleFlag = {}));
export var IhmMultiScaleFlag;
(function (IhmMultiScaleFlag) {
    IhmMultiScaleFlag["N"] = "N";
    IhmMultiScaleFlag["Y"] = "Y";
})(IhmMultiScaleFlag || (IhmMultiScaleFlag = {}));
export var IhmMultiStateFlag;
(function (IhmMultiStateFlag) {
    IhmMultiStateFlag["N"] = "N";
    IhmMultiStateFlag["Y"] = "Y";
})(IhmMultiStateFlag || (IhmMultiStateFlag = {}));
export var IhmOrderedStateFlag;
(function (IhmOrderedStateFlag) {
    IhmOrderedStateFlag["N"] = "N";
    IhmOrderedStateFlag["Y"] = "Y";
})(IhmOrderedStateFlag || (IhmOrderedStateFlag = {}));
export var StructureDeterminationMethodology;
...
})(LsMatrixType || (LsMatrixType = {}));
export var PdbxTlsResidualAdpFlag;
...
})(PdbxTlsResidualAdpFlag || (PdbxTlsResidualAdpFlag = {}));
export var Language;
(function (Language) {
    Language["Ada"] = "Ada";
    Language["Awk"] = "Awk";
...
export var PdbxCaspFlag;
(function (PdbxCaspFlag) {
    PdbxCaspFlag["N"] = "N";
    PdbxCaspFlag["Y"] = "Y";
})(PdbxCaspFlag || (PdbxCaspFlag = {}));
export var CellSetting;
...
export var IsBestInstance;
(function (IsBestInstance) {
    IsBestInstance["N"] = "N";
    IsBestInstance["Y"] = "Y";
})(IsBestInstance || (IsBestInstance = {}));
export var IsSubjectOfInvestigation;
(function (IsSubjectOfInvestigation) {
    IsSubjectOfInvestigation["N"] = "N";
    IsSubjectOfInvestigation["Y"] = "Y";
})(IsSubjectOfInvestigation || (IsSubjectOfInvestigation = {}));
export var IsSubjectOfInvestigationProvenance;
...
})(IsSubjectOfInvestigationProvenance || (IsSubjectOfInvestigationProvenance = {}));
export var TargetIsBound;
(function (TargetIsBound) {
    TargetIsBound["N"] = "N";
    TargetIsBound["Y"] = "Y";
})(TargetIsBound || (TargetIsBound = {}));
export var RcsbPfamSeedSource;
...
})(RcsbPfamSeedSource || (RcsbPfamSeedSource = {}));
export var RcsbPfamProvenanceCode;
(function (RcsbPfamProvenanceCode) {
    RcsbPfamProvenanceCode["PfamA_"] = "Pfam-A";
})(RcsbPfamProvenanceCode || (RcsbPfamProvenanceCode = {}));
export var NstdLinkage;
(function (NstdLinkage) {
    NstdLinkage["N"] = "n";
    NstdLinkage["No"] = "no";
    NstdLinkage["Y"] = "y";
    NstdLinkage["Yes"] = "yes";
})(NstdLinkage || (NstdLinkage = {}));
export var NstdMonomer;
(function (NstdMonomer) {
    NstdMonomer["N"] = "n";
    NstdMonomer["No"] = "no";
    NstdMonomer["Y"] = "y";
    NstdMonomer["Yes"] = "yes";
})(NstdMonomer || (NstdMonomer = {}));
export var PdbxSequenceEvidenceCode;
...
})(PdbxSequenceEvidenceCode || (PdbxSequenceEvidenceCode = {}));
export var RcsbEntityPolymerType;
...
})(RcsbEntityPolymerType || (RcsbEntityPolymerType = {}));
export var PdbxAltSourceFlag;
(function (PdbxAltSourceFlag) {
    PdbxAltSourceFlag["Model"] = "model";
    PdbxAltSourceFlag["Sample"] = "sample";
})(PdbxAltSourceFlag || (PdbxAltSourceFlag = {}));
export var PdbxSeqType;
...
export var RcsbMultipleSourceFlag;
(function (RcsbMultipleSourceFlag) {
    RcsbMultipleSourceFlag["N"] = "N";
    RcsbMultipleSourceFlag["Y"] = "Y";
})(RcsbMultipleSourceFlag || (RcsbMultipleSourceFlag = {}));
export var SrcMethod;
(function (SrcMethod) {
    SrcMethod["Man"] = "man";
    SrcMethod["Nat"] = "nat";
    SrcMethod["Syn"] = "syn";
...
export var RelatedResourceName;
...
export var BindingAssayValueType;
...
})(BindingAssayValueType || (BindingAssayValueType = {}));
export var NeighborFlag;
(function (NeighborFlag) {
    NeighborFlag["N"] = "N";
    NeighborFlag["Y"] = "Y";
})(NeighborFlag || (NeighborFlag = {}));
export var RcsbMembraneLineageProvenanceCode;
...
})(RcsbMembraneLineageProvenanceCode || (RcsbMembraneLineageProvenanceCode = {}));
export var ReferenceName;
(function (ReferenceName) {
    ReferenceName["Impc"] = "IMPC";
    ReferenceName["Gtex"] = "GTEX";
    ReferenceName["Pharos"] = "PHAROS";
})(ReferenceName || (ReferenceName = {}));
export var GroupProvenanceId;
...
export var GroupMembersGranularity;
