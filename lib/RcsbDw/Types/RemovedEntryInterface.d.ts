...
export interface SchemaRepositoryHoldingsCollectionRepositoryHoldingsRemovedEntryVersion330 {
    ...
    rcsb_repository_holdings_removed?: {
         ...
         */
        remove_date?: string;
        repository_content_types?: ("Combined NMR data (NEF)" | "Combined NMR data (NMR-STAR)" | "NMR chemical shifts" | "NMR restraints V1" | "NMR restraints V2" | "assembly PDB" | "assembly mmCIF" | "entry PDB" | "entry PDB bundle" | "entry PDBML" | "entry mmCIF" | "structure factors")[];
        /**
         * The entry title.
         */
        title?: string;
    ...
    rcsb_repository_holdings_transferred?: {
        ...
        repository_content_types?: ("Combined NMR data (NEF)" | "Combined NMR data (NMR-STAR)" | "NMR chemical shifts" | "NMR restraints" | "coordinates" | "structure factors")[];
        /**
         * The release status for the entry.
         */
        status_code?: "TRSF";
