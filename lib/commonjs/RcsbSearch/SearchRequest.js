...
const codegen_search_json_1 = tslib_1.__importDefault(require("./ServerConfig/codegen.search.json"));
const LocalStorageTools_1 = require("../RcsbLocalStorage/LocalStorageTools");
class SearchRequest {
    constructor(uri, externalFetch, requestConfig) {
        var _a, _b;
        this.uri = uri !== null && uri !== void 0 ? uri : codegen_search_json_1.default.uri;
    ...
    request(query_1) {
        return tslib_1.__awaiter(this, arguments, void 0, function* (query, headers = {}) {
            var _a, _b;
            const localObj = LocalStorageTools_1.LocalStorageTools.getItem(query);
            if (localObj)
                return localObj;
            ...
            try {
                ...
                LocalStorageTools_1.LocalStorageTools.setItem(query, queryResult);
                return queryResult;
            }
            catch (e) {
                console.error(e);
