...
export interface SchemaRepositoryHoldingsCollectionRepositoryHoldingsCurrentEntryVersion350 {
    rcsb_repository_holdings_current?: {
        repository_content_types?: ("2fo-fc Map" | "Combined NMR data (NEF)" | "Combined NMR data (NMR-STAR)" | "FASTA sequence" | "Map Coefficients" | "NMR chemical shifts" | "NMR restraints V1" | "NMR restraints V2" | "assembly PDB" | "assembly mmCIF" | "entry PDB" | "entry PDB bundle" | "entry PDBML" | "entry mmCIF" | "fo-fc Map" | "structure factors" | "validation 2fo-fc coefficients" | "validation data mmCIF" | "validation fo-fc coefficients" | "validation report" | "validation slider image")[];
    };
