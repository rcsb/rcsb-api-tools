...
const codegen_borrego_json_1 = tslib_1.__importDefault(require("./ServerConfig/codegen.borrego.json"));
const codegen_yosemite_json_1 = tslib_1.__importDefault(require("./ServerConfig/codegen.yosemite.json"));
const LocalStorageTools_1 = require("../RcsbLocalStorage/LocalStorageTools");
class GraphQLRequest {
    constructor(api, config) {
        switch (api) {
            case "data-api":
                this.client = new graphql_request_1.GraphQLClient(codegen_yosemite_json_1.default.schema, config);
                break;
            case "sequence-coordinates":
            case "1d-coordinates":
                this.client = new graphql_request_1.GraphQLClient(codegen_borrego_json_1.default.schema, config);
                break;
            default:
