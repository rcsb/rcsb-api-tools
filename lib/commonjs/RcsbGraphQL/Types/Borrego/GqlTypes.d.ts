...
export declare enum AnnotationReference {
...
export declare enum FeaturesAdditionalPropertiesPropertyName {
...
export declare enum FeaturesType {
    ...
    MogulRingOutliers = "MOGUL_RING_OUTLIERS",
    MogulTorsionOutliers = "MOGUL_TORSION_OUTLIERS",
...
export declare enum GroupReference {
...
export declare enum SequenceReference {
